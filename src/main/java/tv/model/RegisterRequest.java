...
public class RegisterRequest {
    ...
    public RegisterRequest(String endpointClientName, int lifetime, String LWM2MVersion, String bindingMode, String SMSNumber, String objectsAndObjectInstances) {
